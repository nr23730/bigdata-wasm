...
var literalNames = [null, "'if'", "'('", "')'", "'else'", "'{'", "'}'",
    ...
    "'<'", "'<='", "'>'", "'>='", "'=='", "'!='", "'&&'",
    "'||'", "'var'", "':'", "'='", "'fun'", "'return'",
    "','", null, "'String'", "'Boolean'", "'Int'"];

var symbolicNames = [null, null, null, null, null, null, null, null, null,
    null, null, null, null, null, null, null, null, null,
    null, null, null, null, null, null, null, null, null,
    null, "TYPES", "STRINGTYPE", "BOOLTYPE", "INTTYPE",
    "IDENTIFIER", "NUMBER", "STRING", "WHITESPACE"];

var ruleNames = ["program", "programPart", "statement", "branch", "block",
...
BigDataParser.STRINGTYPE = 29;
BigDataParser.BOOLTYPE = 30;
BigDataParser.INTTYPE = 31;
BigDataParser.IDENTIFIER = 32;
BigDataParser.NUMBER = 33;
BigDataParser.STRING = 34;
BigDataParser.WHITESPACE = 35;
...
BigDataParser.StringContext = StringContext;

StringContext.prototype.STRING = function () {
    return this.getToken(BigDataParser.STRING, 0);
};
...
BigDataParser.NumberContext = NumberContext;

NumberContext.prototype.NUMBER = function () {
    return this.getToken(BigDataParser.NUMBER, 0);
};
    ...
    try {
        ...
        switch (la_) {
            case 1:
                ...
                this.state = 89;
                localctx.number = this.match(BigDataParser.NUMBER);
                break;
            ...
            case 4:
                ...
                _prevctx = localctx;
                this.state = 92;
                localctx.txt = this.match(BigDataParser.STRING);
                break;
    ...
    try {
        ...
        switch (la_) {
            case 1:
                ...
                this.state = 139;
                this.match(BigDataParser.TYPES);
                this.state = 140;
...
BigDataParser.prototype.statementList = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while (((((_la - 1)) & ~0x1f) == 0 && ((1 << (_la - 1)) & ((1 << (BigDataParser.T__0 - 1)) | (1 << (BigDataParser.T__6 - 1)) | (1 << (BigDataParser.T__7 - 1)) | (1 << (BigDataParser.T__21 - 1)) | (1 << (BigDataParser.IDENTIFIER - 1)))) !== 0)) {
            this.state = 192;
            this.statement();
            this.state = 197;
            this._errHandler.sync(this);
