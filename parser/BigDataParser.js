...
var literalNames = [null, "'private'", "'public'", "'fun'", "'('", "')'",
    "':'", "','", "'='", "'{'", "'}'", "'if'", "'else'",
    "'return'", "'do'", "'while'", "'for'", "';'", "'var'",
    "'val'", "'memory'", "'['", "']'", "'println'", "'++'",
    "'--'", "'/'", "'*'", "'-'", "'+'", "'<'", "'<='",
    "'>'", "'>='", "'=='", "'!='", "'&&'", "'||'", null,
...
BigDataParser.prototype.program = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << BigDataParser.T__0) | (1 << BigDataParser.T__1) | (1 << BigDataParser.T__2))) !== 0));
        this.state = 59;
...
BigDataParser.prototype.functionDefinition = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === BigDataParser.T__0 || _la === BigDataParser.T__1) {
            this.state = 63;
...
BigDataParser.prototype.statementList = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << BigDataParser.T__10) | (1 << BigDataParser.T__12) | (1 << BigDataParser.T__13) | (1 << BigDataParser.T__14) | (1 << BigDataParser.T__15) | (1 << BigDataParser.T__17) | (1 << BigDataParser.T__18) | (1 << BigDataParser.T__19) | (1 << BigDataParser.T__22))) !== 0) || _la === BigDataParser.IDENTIFIER) {
            this.state = 117;
            this.statement();
            this.state = 122;
            this._errHandler.sync(this);
...
BigDataParser.prototype.functionCall = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << BigDataParser.T__3) | (1 << BigDataParser.T__19) | (1 << BigDataParser.T__23) | (1 << BigDataParser.T__24))) !== 0) || ((((_la - 44)) & ~0x1f) == 0 && ((1 << (_la - 44)) & ((1 << (BigDataParser.BOOLEANLITERAL - 44)) | (1 << (BigDataParser.IDENTIFIER - 44)) | (1 << (BigDataParser.INTEGER - 44)) | (1 << (BigDataParser.LONG - 44)) | (1 << (BigDataParser.FLOAT - 44)) | (1 << (BigDataParser.DOUBLE - 44)))) !== 0)) {
            this.state = 125;
            this.expressionList();
            this.state = 130;
            this._errHandler.sync(this);
